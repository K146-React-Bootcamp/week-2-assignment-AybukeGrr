...
const renderTodos = (page = 1) => {
  ...
  thead.innerHTML = `
    <tr>
      <th scope="col" id="id-sorting">id <button>&darr;</button></th>
      <th scope="col" id="title-sorting">Başlık <button>&darr;</button></th>
      <th scope="col" id="user-sorting">Kullanıcı Id  <button>&darr;</button></th>
      <th scope="col" id="status-sorting">Durum <button>&darr;</button></th>
      <th scope="col"></th>
    </tr>
  `;
